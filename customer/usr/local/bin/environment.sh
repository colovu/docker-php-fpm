...
# 应用配置参数
export PHP_FPM_CONF_FILE="${PHP_FPM_CONF_FILE:-${APP_CONF_DIR}/php-fpm.conf}"
export PHP_FPM_PORT=${PHP_FPM_PORT:-9000}

# 内部变量
export APP_PID_FILE="${APP_PID_FILE:-${APP_RUN_DIR}/php-fpm.pid}"
export APP_LOG_FILE="${APP_LOG_FILE:-${APP_LOG_DIR}/php-fpm.log}"
